...
class ImageScanner:
    ...
    def _perform_ocr(self, image_path: str) -> str:
        ...
        # In a real implementation, you would use libraries like Tesseract,
        # Google Cloud Vision, or other OCR services
        ...
        try:
            ...
            extracted_text = f"MOCK OCR TEXT: This image may contain personal data scanned from {image_path}."
            
            # For testing purposes, if the filename contains certain keywords, 
            # return text that will trigger specific PII detection
            lower_filename = image_path.lower()
            if "passport" in lower_filename or "id" in lower_filename:
                extracted_text += " ID: ABC123456, Name: John Doe, DOB: 01-01-1980"
            elif "credit" in lower_filename or "card" in lower_filename:
                extracted_text += " Card Number: 4111-1111-1111-1111, Exp: 12/25, CVV: 123"
            elif "license" in lower_filename:
                extracted_text += " Driver License: DL123456789, Issued: Amsterdam"
            elif "medical" in lower_filename or "health" in lower_filename:
                extracted_text += " Patient ID: 987654321, Diagnosis: Hypertension, Doctor: Dr. Smith"
